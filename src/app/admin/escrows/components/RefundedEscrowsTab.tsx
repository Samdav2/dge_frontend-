...
export default function RefundedEscrowsTab({ onRowClick }: RefundedEscrowsTabProps) {
    const escrows: EscrowItem[] = [
        { id: "Ngo-0001", seller: "Ikoro Jessica", buyer: "Nnaji Christian", service: "Urgently seeking skilled car...", price: "₦9,900", date: "09/03/2025", status: "REFUNDED" },
        { id: "Ngo-0002", seller: "Mabel Nzekew", buyer: "Ikoro Jessica", service: "Looking for an experienced...", price: "₦4,000", date: "09/03/2025", status: "REFUNDED" },
        { id: "Ngo-0003", seller: "Nnaji Christian", buyer: "Mabel Nzekew", service: "Looking for an experienced...", price: "₦4,000", date: "09/03/2025", status: "REFUNDED" },
        { id: "Ngo-0004", seller: "Ibrahim Fatima", buyer: "Jaxon Lee", service: "Seeking a skilled UI/UX desi...", price: "₦4,500", date: "09/03/2025", status: "REFUNDED" },
        { id: "Ngo-0005", seller: "Nguyen Minh", buyer: "Sophia Kim", service: "Hiring a talented motion gr...", price: "₦5,000", date: "09/03/2025", status: "REFUNDED" },
        { id: "Ngo-0006", seller: "Patel Priya", buyer: "Chase Thompson", service: "In need of a creative web d...", price: "₦5,500", date: "09/03/2025", status: "REFUNDED" },
        { id: "Ngo-0007", seller: "Johnson Michael", buyer: "Isabella Garcia", service: "Looking for an innovative ill...", price: "₦6,000", date: "09/03/2025", status: "REFUNDED" },
        { id: "Ngo-0008", seller: "Smith Sarah", buyer: "Liam Patel", service: "Searching for a proficient s...", price: "₦6,500", date: "09/03/2025", status: "REFUNDED" },
        { id: "Ngo-0009", seller: "Garcia Luis", buyer: "Zara Ahmed", service: "Requesting an adept photo...", price: "₦7,000", date: "09/03/2025", status: "REFUNDED" }
    ];
                ...
                <tbody className="divide-y divide-slate-50">
                    {escrows.map((item, idx) => (
                        ...
                        >
                            ...
                            <td className="py-4 px-2 select-none">
                                <span className="inline-flex items-center px-2 py-0.5 rounded-md font-bold text-[9px] bg-red-50 text-red-600 border border-red-100 select-none">
                                    REFUNDED
                                </span>
                            </td>
